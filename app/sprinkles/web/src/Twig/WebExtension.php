...
class WebExtension extends \Twig_Extension
{
    ...
    public function getFilters()
    {
        return array(
            ...
            new \Twig_SimpleFilter('navigation', array($this, 'navigationUrlFilter')),
    ...
    public function getFunctions()
    {
        return array(
            ...
            new \Twig_SimpleFunction('blur_username', array($this, 'blurUserName')),
...
//        }
    ...
    public function navigationUrlFilter($url)
    {
        ...
        return $this->container->get('request')->getUri()->getBasePath().'/'.$url;
    }
